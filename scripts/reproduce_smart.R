...
phases <- list(
  ...
  list(label = "Phase 2C — Score candidates",
       script = "scripts/score_candidates.R",
  ...
  list(label = "Phase 5D — Test-set evaluation",
       script = "scripts/score_test_set.R",
       sentinel = "analysis/phase4/test_evaluation_summary.csv"),
  list(label = "Phase 5D — Test leaderboard",
       script = "scripts/score_test_leaderboard.R",
       sentinel = "analysis/phase4/test_leaderboard.csv"),
  list(label = "Phase 5E — Validation coverage",
